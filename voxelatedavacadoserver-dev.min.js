var websock=require("ws"),fs=require("fs"),struct=require("./boc_struct.js"),boc_handshake=require("./boc_handshake.js"),boc_trivia=require("./boc_trivia.js");console.log("Starting VoxelatedAvacado server.");var server=require("https").createServer({cert:fs.readFileSync("/etc/letsencrypt/live/brawlochums.gq/cert.pem"),key:fs.readFileSync("/etc/letsencrypt/live/brawlochums.gq/privkey.pem"),port:36245}),wss=new websock.Server({server:server,path:"/ws/"});
