...
break}}else"client"===b.type?"undefined"!==typeof b.code&&connections.has(b.code)?"undefined"===typeof b.name?(a.send('{"e":"Invalid or nonexistant name."}'),console.log("-Ended connection with "+a._socket.remoteAddress+" (4003)"),a.close(4003)):(a.clientType="client",a.gameCode=b.code,a.playerName=b.name,connections.get(b.code).clients.push(a),a.send('{"joingame":"true"}')):(a.send('{"e":"Invalid game code."}'),console.log("-Ended connection with "+a._socket.remoteAddress+" (4001)"),a.close(4001)):
(a.send('{"e":"Invalid type provided on handshake message."}'),console.log("-Ended connection with "+a._socket.remoteAddress+" (4000)"),a.close(4E3))};a.onclose=function(){}});
