...
function DoJoinGame(){gameCode=document.getElementById("base-gameCode").value.toUpperCase();playerName=document.getElementById("base-playerName").value;var b=new WebSocket("ws://localhost:36245");b.onopen=function(a){console.log("Connection Established!");b.send('{"type":"client","code":"'+gameCode+'","name":"'+playerName+'"}')};b.onmessage=function(a){console.log(a.data);JSON.parse(a.data).joingame&&(document.getElementById("base-codeEntry").style.display="none",document.getElementById("other-lobby").style.display=
"initial")};b.onclose=function(a){console.log("Connection lost! ("+a.code+")");switch(a.code){case 4001:document.getElementById("error-nogamecode").style.display="initial";break;default:document.getElementById("error-connection").style.display="initial"}}};
