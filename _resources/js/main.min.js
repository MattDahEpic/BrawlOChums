...
b[2];document.getElementById("trivia-question4").innerText=b[3]}"hidequestion"===a.trivia&&(document.getElementById("other-logo").style.display="initial",document.getElementById("trivia").style.display="none")}},ws.onclose=function(a){console.log("Connection lost! ("+a.code+")");switch(a.code){case 4001:document.getElementById("error-nogamecode").style.display="initial";break;default:document.getElementById("error-connection").style.display="initial"}}))}
